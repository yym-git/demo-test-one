 ...
 * @date 14:58 2021/1/4
 */
public class ImooCache4<K, V> implements Computable<K, V> {
    private final HashMap<K, V> cache = new HashMap<>();
    private Computable<K, V> c;

    public ImooCache4(Computable<K, V> c) {
        this.c = c;
    }

    /**
     * @description 存在写的过程进行读的并发安全问题
     *      * @author ym.y
     * @author ym.y
     * @updateUser
     * @date  16:33 2021/1/4
    ...
    public static void main(String[] args) throws Exception {
        ImooCache4<String,Integer> imooCache2 = new ImooCache4(new ExpensiveFunction());
